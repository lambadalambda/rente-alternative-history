...
- Arbeitsstand 2026-05-04: `scripts/build_drv_cashflows.py` lädt die DRV-PDF, prüft den SHA-256-Hash und erzeugt `data/extracted/drv/allgemeine-rv-cashflows.csv` sowie `data/website/allgemeine-rv-cashflows.json`. Eine erste Stichprobenkontrolle liegt unter `data/quality/drv/allgemeine-rv-cashflow-spotchecks.json`; Korrekturseiten-Abgleich und vollständige Tabellenprüfung fehlen noch.
